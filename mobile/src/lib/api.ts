...
//   1. EXPO_PUBLIC_API_URL (set in .env / eas secrets)
//   2. Metro host LAN IP + :3000 (dev convenience on a physical device)
//   3. http://localhost:3000 (simulator fallback)
...
export function searchListings(params: SearchListingsParams): Promise<Listing[]> {
